...
export default class StockZoneStack extends React.Component {
    constructor(props) {
        super(props);
        this.state  = {
            pageno: 1,
    ...
    fetchDataFromApi = ()  => {
        ...
        form.append('zone_id', this.props.navigation.state.params.zone_id);
        form.append('pageno', this.state.pageno);

        fetch(global.URL + '/stock/zone/stack', {
            method: 'POST',
            body: form
            })
      ...
      render() {
        ...
        return (
            <View style={wrapper}>
                ...
                {params.stockname}: ZONE {params.zone_name}</Text>
                <ListView
                    refreshControl={
                        <RefreshControl
