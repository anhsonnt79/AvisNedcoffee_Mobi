...
export default class StockZone extends React.Component {
    constructor(props) {
        super(props);
        this.state  = {
            pageno: 1,
                ...
                <ListView
                    ...
                    renderRow={(rowData)=> (
                        <View style={productStyle}>
                            ...
                            <TouchableOpacity onPress={() => this.props.navigation.navigate('StockZoneStack',
                          {stock_id: `${rowData.stock_id}`, zone_id: `${rowData.zone_id}`,
                          stockname: `${rowData.stockname}`, zone_name: `${rowData.zone_name}`})}>
                                <View style={{ justifyContent: 'center'}}>
                                    <Text style={labelRight}>{rowData.zone_name}</Text>
                                </View>
